...
export class ComponentResolver {
    ...
    @Autowired("namedComponentResolver") private namedComponentResolver: NamedComponentResolver;
    ...
    (
        ...
        if (HardcodedJsComponent) {
            ...
            return {
                type: ComponentType.JB_CONTROLS,
        ...
        if (hardcodedJsFunction){
            ...
            return <ResolvedComponent<A,B>>this.agComponentUtils.adaptFunction(propertyName, hardcodedJsFunction, ComponentType.JB_CONTROLS, ComponentSource.HARDCODED);
        }
    ...
    public mergeParams(
        ...
        if (!finalParams.api){
            finalParams.api = this.dropdownOptions.api;
        }
    ...
    public createAgGridComponent<A extends IComponent<any>> (
        ...
        let holder:ComponentHolder = holderOpt == null ? this.dropdownOptions : holderOpt;
        let componentName:string = componentNameOpt == null ? propertyName : componentNameOpt;
    ...
    (
        ...
        if (componentToUse.type === ComponentType.JB_CONTROLS){
